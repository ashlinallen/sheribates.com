...
require('../css/vendor/slick/slick.css');
require('../css/vendor/slick/slick-theme.css');
require('../css/vendor/fancybox/jquery.fancybox.css');
require('../css/fonts.css');
require('../less/styles.less');
(function () {
    "use strict";

    var images, imagesArr, isMobile, designSlider, illustrationSlider;
        ...
        return {
            ...
            init : function () {
                ...
                for (i = 0; i < imagesArr.length; i += 1) {
                    ...
                    imgUrl = "images/Examples/" + imagesArr[i].gallery + "/" + imagesArr[i].subcat + "/" + imagesArr[i].filename;
